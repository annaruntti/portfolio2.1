...
export default function IntroductionBlock() {
    return (
        <div className="introduction-block">
            ...
            <p className="ingress">Olen 30-vuotias, oppimaan innokas koodari Anna ja hurahtanut pahasti myös UX- ja UI-desigiin, saavutettavuuteen ja graafiseen designiin.</p>
