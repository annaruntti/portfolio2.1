        ...
        <div className="show-content-design">
            ...
            <div className="project-box">
                ...
                <div className="image-box">
                    <div className="row">
                        <div className="image-wrapper">
                            <img className="litterplan-image" src={LitterPlansImage} alt="Litterplan image" />
                        </div>
                        <div className="image-wrapper">
                            <img className="litterplan-image" src={LitterPlansImage3} alt="Litterplan image" />
                        </div>
                        <div className="image-wrapper">
                            <img className="litterplan-image" src={LitterPlansImage2} alt="Litterplan image" />
                        </div>
                    </div>
                </div>
            </div>
            <div className="project-box">
                <div className="row">
                    <div className="text-introduction">
                        ...
                        <p>
                            Olen tehnyt eri yhdistyksien käyttöön niiden Facebook-tapahtumiin "coverphotoja". Olen tehnyt kuviin grafiikkaa ja muokannut kuvat käyttäen valkovia, eri fontteja ja greaafisia elementtejä. Kuvat olen tehnyt Adobe Photoshopilla.
                        </p>
                    </div>
                </div>
                <div className="image-box">
                    <div className="row">
                        <div className="image-coverphoto-wrapper">
                            <img className="coverphoto-image" src={CoverPhoto2} alt="Facebook coverphoto" />
                        </div>
                        <div className="image-coverphoto-wrapper">
                            <img className="coverphoto-image" src={CoverPhoto1} alt="Facebook coverphoto" />
                        </div>
                    </div>
                    <div className="row">
                        <div className="image-coverphoto-wrapper">
                            <img className="coverphoto-image" src={CoverPhoto3} alt="Facebook coverphoto" />
                        </div>
                        <div className="image-coverphoto-wrapper">
                            <img className="coverphoto-image" src={CoverPhoto4} alt="Facebook coverphoto" />
                        </div>
                    </div>
                </div>
            </div>
            <div className="project-box">
                <div className="row">
                    <div className="text-introduction">
                        ...
                        <p>
                            Olen tehnyt useana vuonna joulukortteja omaan käyttööni, sekä pyynnöstä myös läheisteni käyttöön. Lisäksi olen tehnyt joitakin kutsukortteja omaan käyttööni sekä sisarelleni. Korttien teossa olen maalannut itse paperille joitakin osia, jonka jälkeen olen kuvannut ne ja editoinut Photoshopissa muut korttien osat.
                        </p>
                    </div>
                </div>
                <div className="image-box">
